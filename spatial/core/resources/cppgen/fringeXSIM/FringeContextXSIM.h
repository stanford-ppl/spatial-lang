#ifndef __FRINGE_CONTEXT_XSIM_H__
#define __FRINGE_CONTEXT_XSIM_H__
...
class FringeContextXSIM : public FringeContextBase<void> {
...
public:
  ...
  FringeContextXSIM(std::string path = "") : FringeContextBase(path) {
