...
//---------------------------- 
   ...
   cl_tst_scrb #(.DATA_WIDTH(512),
         ...
         .DIRECT_rdata_valid(ddrc_tst_cfg_bus_q.DIRECT_rdata_valid),
...
//---------------------------- 
   ...
   cl_tst_scrb #(.DATA_WIDTH(512),
         ...
         .DIRECT_rdata_valid(ddra_tst_cfg_bus.DIRECT_rdata_valid),
...
//---------------------------- 
   ...
   cl_tst_scrb #(.DATA_WIDTH(512),
         ...
         .DIRECT_rdata_valid(ddrb_tst_cfg_bus_q.DIRECT_rdata_valid),
...
//---------------------------- 
   ...
   cl_tst_scrb #(.DATA_WIDTH(512),
         ...
         .DIRECT_rdata_valid(ddrd_tst_cfg_bus_q.DIRECT_rdata_valid),
