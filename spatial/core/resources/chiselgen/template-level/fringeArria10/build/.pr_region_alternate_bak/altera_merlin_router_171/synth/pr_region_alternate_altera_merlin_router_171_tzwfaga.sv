...
module pr_region_alternate_altera_merlin_router_171_tzwfaga_default_decode
  #(
...
module pr_region_alternate_altera_merlin_router_171_tzwfaga
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    pr_region_alternate_altera_merlin_router_171_tzwfaga_default_decode the_default_decode(
    ...
    // ( 0x200 .. 0x208 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 10'h200  && read_transaction  ) begin
            src_channel = 2'b01;
