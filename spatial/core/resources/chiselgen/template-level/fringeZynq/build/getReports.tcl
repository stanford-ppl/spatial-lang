...
report_utilization -packthru -hierarchical -hierarchical_depth 20 -hierarchical_percentages -file ./REPORT_synth_utilization.rpt
...
report_utilization -packthru -hierarchical -hierarchical_depth 20 -hierarchical_percentages -file  ./REPORT_par_utilization.rpt
