...
switch $TARGET {
  "ZCU102" {
    ...
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
