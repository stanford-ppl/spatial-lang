...
switch $TARGET {
  "ZCU102" {
    ...
    # Loopback debuggers
    # top signals
    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_ARVALID] [get_bd_pins Top_0/io_TOP_AXI_ARVALID]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_arvalid] [get_bd_pins TOP_0/io_M_AXI_ARVALID]
    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_ARREADY] [get_bd_pins Top_0/io_TOP_AXI_ARREADY]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_arready] [get_bd_pins TOP_0/io_M_AXI_ARREADY]
    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_ARADDR] [get_bd_pins Top_0/io_TOP_AXI_ARADDR]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_araddr] [get_bd_pins TOP_0/io_M_AXI_ARADDR]
    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_ARLEN] [get_bd_pins Top_0/io_TOP_AXI_ARLEN]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_arlen] [get_bd_pins TOP_0/io_M_AXI_ARLEN]

    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_AWVALID] [get_bd_pins Top_0/io_TOP_AXI_AWVALID]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_awvalid] [get_bd_pins TOP_0/io_M_AXI_AWVALID]
    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_AWREADY] [get_bd_pins Top_0/io_TOP_AXI_AWREADY]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_awready] [get_bd_pins TOP_0/io_M_AXI_AWREADY]
    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_AWADDR] [get_bd_pins Top_0/io_TOP_AXI_AWADDR]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_awaddr] [get_bd_pins TOP_0/io_M_AXI_AWADDR]

    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_RVALID] [get_bd_pins Top_0/io_TOP_AXI_RVALID]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_rvalid] [get_bd_pins TOP_0/io_M_AXI_RVALID]
    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_RREADY] [get_bd_pins Top_0/io_TOP_AXI_RREADY]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_rready] [get_bd_pins TOP_0/io_M_AXI_RREADY]

    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_WVALID] [get_bd_pins Top_0/io_TOP_AXI_WVALID]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_wvalid] [get_bd_pins TOP_0/io_M_AXI_WVALID]
    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_WREADY] [get_bd_pins Top_0/io_TOP_AXI_WREADY]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_wready] [get_bd_pins TOP_0/io_M_AXI_WREADY]

    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_BVALID] [get_bd_pins Top_0/io_TOP_AXI_BVALID]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_bvalid] [get_bd_pins TOP_0/io_M_AXI_BVALID]
    connect_bd_net [get_bd_pins TOP_0/io_M_AXI_BREADY] [get_bd_pins Top_0/io_TOP_AXI_BREADY]
    connect_bd_net [get_bd_pins axi_dwidth_converter_0/s_axi_bready] [get_bd_pins TOP_0/io_M_AXI_BREADY]
