...
trait Primitives extends Benchmarks {
  ...
  bases +:= MetaProgGen("Static", Seq(50,100,200), StaticOp[Int8]("8", {() => 32.to[Int8] }))
  bases +:= MetaProgGen("Static", Seq(50,100,200), StaticOp[Int16]("16", {() => 32.to[Int16] }))
  bases +:= MetaProgGen("Static", Seq(50,100,200), StaticOp[Int32]("32", {() => 32.to[Int32] }))
  bases +:= MetaProgGen("Static", Seq(50,100,200), StaticOp[Int64]("64", {() => 32.to[Int64] }))
