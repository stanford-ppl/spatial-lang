...
case object PIRFixUsra   extends PIROp { override def toString = "FixUsra" }
...
case object PIRFixRandom extends PIROp { override def toString = "FixRandom" }
case object PIRFixUnif extends PIROp { override def toString = "FixUnif" }
case object PIRFixConvert extends PIROp { override def toString = "FixConvert" }
...
case object PIRBitNot  extends PIROp { override def toString = "BitNot"  }
case object PIRBitXor  extends PIROp { override def toString = "BitXor"  }
