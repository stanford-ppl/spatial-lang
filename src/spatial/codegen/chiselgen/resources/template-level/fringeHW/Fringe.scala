...
class Fringe(
  ...
  io.dbg_num_enable := mag.io.dbg_num_enable
  io.dbg_num_cmd_valid := mag.io.dbg_num_cmd_valid
  io.dbg_num_cmd_valid_enable := mag.io.dbg_num_cmd_valid_enable
  io.dbg_num_cmd_ready := mag.io.dbg_num_cmd_ready
  io.dbg_num_cmd_ready_enable := mag.io.dbg_num_cmd_ready_enable
  io.dbg_num_resp_valid := mag.io.dbg_num_resp_valid
  io.dbg_num_resp_valid_enable := mag.io.dbg_num_resp_valid_enable

  io.dbg_num_rdata_enq := mag.io.dbg_num_rdata_enq
  io.dbg_num_rdata_deq := mag.io.dbg_num_rdata_deq
  io.dbg_num_app_rdata_ready := mag.io.dbg_num_app_rdata_ready
